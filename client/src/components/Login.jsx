  ...
  return (
    ...
    justify-center items-center'>
        ...
        text-slate-500' >
            ...
            { state !=='Login' && <div className='border px-6 py-0.5 full items-center gap-2
            rounded-full mt-5 flex items-center justify-between  '>
                <img src={assets.user_icon} alt="" className='h-11' />
                <input onChange={e=>setName(e.target.value)} value={name}
                type="text" className='outline-none text-sm ' 
                placeholder='Full Name'  required />
            </div>}

             <div className='border px-6 py-3 full items-center gap-2
            rounded-full mt-4 flex items-center justify-between '>
            ...
            <img onClick={()=>setShowLogin(false)}src={assets.cross_icon} alt="" className='absolute
