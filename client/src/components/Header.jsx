    ...
    viewport={{once:true}}>
      ...
      bg-white px-6 py-1 rounded-full border border-neutral-500'
        ...
        sm:max-w-[590px] mx-auto mt-10 text-center'>Turn Text to
         ...
         >
            Bring your imagination to life with AI. Simply type your idea and watch it transform into stunning visuals instantly.
         </motion.p>

         <motion.button onClick={onClickHandler}
         className='sm:text-lg text-white bg-black w-auto
         mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full mx-auto'
        ...
        transition={{delay:1.2,duration:0.8}}
          className='mt-2 text-neutral-600'>Generated images from SpellPix</motion.p>
